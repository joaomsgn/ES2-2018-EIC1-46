...
public class ExperimentsIntegerExternalViaJAR {
	...
	public void start() throws IOException {
		...
		MyProblemIntegerExternalViaJAR proble =new MyProblemIntegerExternalViaJAR(prob);
		...
		Experiment<IntegerSolution, List<IntegerSolution>> experiment = new ExperimentBuilder<IntegerSolution, List<IntegerSolution>>(
				"ExperimentsIntegerExternalViaJAR").setAlgorithmList(algorithmList).setProblemList(problemList)
